...
import seedu.address.model.person.utils.NameContainsKeywordsPredicate;
...
public class CommandTestUtil {
    ...
    public static final String VALID_POINTS_AMY = "0";
    public static final String VALID_POINTS_BOB = "0";
